...
try:
    ...
    from openvas_cli_scanner.cli.parser import create_parser
    from openvas_cli_scanner.utils.logging import setup_logging, get_logger, log_scan_start, log_scan_complete
    from openvas_cli_scanner.scanner.manager import ScannerManager, ScanRequest
    from openvas_cli_scanner.installation import (
        setup_openvas, 
        check_openvas_status, 
        print_dependency_info,
        OpenVASDetector
