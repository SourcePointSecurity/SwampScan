"""
SwampScan - Advanced Vulnerability Scanner

A powerful Python command-line interface for OpenVAS vulnerability scanner with automatic
installation capabilities and flexible output formatting. SwampScan lurks in the depths
of your network, hunting for security vulnerabilities with the stealth of a swamp predator.
"""

__version__ = "1.0.0"
__author__ = "SourcePoint Security"
__description__ = "Advanced vulnerability scanner with OpenVAS integration"
